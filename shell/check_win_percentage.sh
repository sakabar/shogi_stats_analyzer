...
cat $tmp_file | $py_cmd src/check_win_percentage.py  50 5  | column -t > win_percentage.txt &
cat $tmp_file | $py_cmd src/check_win_percentage.py 100 5  | column -t > /dev/null &
wait
